...
//+
Point(2) = {Inner_Radius*0.70710678, Inner_Radius*0.70710678, -Height/2, 1.0};
//+
Point(3) = {-Inner_Radius*0.70710678, Inner_Radius*0.70710678, -Height/2, 1.0};
//+
Point(4) = {Inner_Radius*0.70710678, -Inner_Radius*0.70710678, -Height/2, 1.0};
//+
Point(5) = {-Inner_Radius*0.70710678, -Inner_Radius*0.70710678, -Height/2, 1.0};
//+
Circle(1) = {5, 1, 4};
//+
Circle(2) = {4, 1, 2};
...
//+
Periodic Surface {13, 17, 20, 9} = {1, 2, 3, 4} Translate {0, 0, Height};
//+
