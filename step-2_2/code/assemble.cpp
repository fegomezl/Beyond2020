...
void Artic_sea::assemble_system(){
    ...
    ConstantCoefficient outer_1(0.);
    ConstantCoefficient outer_2(10.);
    x->ProjectCoefficient(outer_1);
    x->ProjectBdrCoefficient(outer_1, dir_bdr);
    x->ProjectBdrCoefficient(outer_2, new_bdr);
    x->GetTrueDofs(X);
