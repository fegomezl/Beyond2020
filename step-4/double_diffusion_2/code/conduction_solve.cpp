...
void Conduction_Operator::Mult(const Vector &X, Vector &dX_dt) const{
    ...
    ProductCoefficient r_newmann_theta(coeff_r, newmann_theta);
    ...
    ProductCoefficient r_newmann_phi(coeff_r, newmann_phi);
...
int Conduction_Operator::SUNImplicitSolve(const Vector &B, Vector &X, double tol){    
    ...
    ProductCoefficient r_newmann_theta(coeff_r, newmann_theta);
    ProductCoefficient dt_r_newmann_theta(Scaled_dt, r_newmann_theta);
    ...
    ProductCoefficient r_newmann_phi(coeff_r, newmann_phi);
    ProductCoefficient dt_r_newmann_phi(Scaled_dt, r_newmann_phi);
