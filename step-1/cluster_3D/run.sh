...
mpiexec -v -np $NSLOTS -host hercules4,hercules3,hercules2 ~/brinicle/step-1/cluster_3D/./main.x --mesh ~/brinicle/step-1/cluster_3D/results/mesh.msh --internal-radius 5 --outer-radius 10 -he 10 -o 1 -r 2
